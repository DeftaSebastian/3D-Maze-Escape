    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newVector = glm::rotate(glm::mat4(1.f), angle, right) * glm::vec4(forward, 1);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newVector = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
            forward = glm::normalize(glm::vec3(newVector));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newVector = glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(right, 1);
            right = glm::normalize(glm::vec3(newVector));
            up = glm::cross(right, forward);
        }
